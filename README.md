...
This template has been tested with Zig `0.15.2`. It may not work with other versions.
...
This repo is based on [SpexGuy's Zig-AoC-Template](https://github.com/SpexGuy/Zig-AoC-Template/).
